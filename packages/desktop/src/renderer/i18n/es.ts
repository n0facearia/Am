export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de AM",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de AM. ¿Quieres instalarla y reiniciar?",
